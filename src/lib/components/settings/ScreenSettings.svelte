...
<div class="flex flex-col gap-7">
  <section>
    <div class="mb-2.5">
      <h2 class="text-[12px] font-semibold">{t("settings.screen.language.title")}</h2>
      <p class="mt-0.5 text-[10.5px] text-muted-foreground">{t("settings.screen.language.desc")}</p>
    </div>
    <div class="inline-flex rounded-[9px] border bg-muted/35 p-0.5">
      {#each LOCALES as option (option)}
        <button type="button" class="h-7 rounded-[7px] px-3.5 text-[11.5px] font-medium {locale.current === option ? 'bg-background text-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground'}" onclick={() => locale.set(option)}>{localeLabels[option]}</button>
      {/each}
    </div>
  </section>
  ...
  <section>
    <div class="mb-2.5">
      <h2 class="text-[12px] font-semibold">{t("settings.screen.theme.title")}</h2>
      <p class="mt-0.5 text-[10.5px] text-muted-foreground">{t("settings.screen.theme.desc")}</p>
    </div>
    <div class="inline-flex rounded-[9px] border bg-muted/35 p-0.5">
      {#each themeOptions as option (option.value)}
        <button type="button" class="h-7 rounded-[7px] px-3.5 text-[11.5px] font-medium {theme.mode === option.value ? 'bg-background text-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground'}" onclick={() => theme.setMode(option.value)}>{t(option.labelKey)}</button>
      {/each}
    </div>
  </section>
  ...
  <section>
    <div class="mb-2.5">
      <h2 class="text-[12px] font-semibold">{t("settings.screen.font.title")}</h2>
      <p class="mt-0.5 text-[10.5px] text-muted-foreground">{t("settings.screen.font.desc")}</p>
    </div>
  ...
  <section>
    <div class="mb-2.5">
      <h2 class="text-[12px] font-semibold">{t("settings.screen.fontSize.title")}</h2>
      <p class="mt-0.5 text-[10.5px] text-muted-foreground">{t("settings.screen.fontSize.desc")}</p>
    </div>
