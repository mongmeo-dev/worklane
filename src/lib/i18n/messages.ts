...
export const en = {
  ...
  "settings.agents.moveUpKind": "Move {label} up",
  "settings.agents.moveDownKind": "Move {label} down",
...
export const ko: Record<MessageKey, string> = {
  ...
  "settings.agents.moveUpKind": "{label} 위로 이동",
  "settings.agents.moveDownKind": "{label} 아래로 이동",
