...
export const en = {
  ...
  "contextMenu.addWorkspace": "Add workspace",
  "contextMenu.openFileManager": "Open file manager",
  "contextMenu.openNearestParent": "Open nearest folder ({path})",
  "contextMenu.renameWorkspace": "Rename workspace",
  "contextMenu.openInExternalApp": "Open in external app",
  "contextMenu.deleteWorkspace": "Delete workspace",
  "contextMenu.expand": "Expand",
  "contextMenu.collapse": "Collapse",
  "contextMenu.revealInFileManager": "Reveal in file manager",
  "contextMenu.copyPath": "Copy path",
  "contextMenu.openVSCode": "Open in VS Code",
  "contextMenu.openCursor": "Open in Cursor",
  "contextMenu.openZed": "Open in Zed",
  "renameAgent.title": "Rename workspace",
  "renameAgent.name": "Workspace name",
  "renameAgent.namePlaceholder": "Enter a workspace name",
  "renameAgent.saving": "Saving…",
  ...
  "overview.firstRunTitle": "Add your first project",
  "overview.firstRunDesc": "Point Worklane at a Git repository. It creates a default workspace so you can start an agent right away.",
  ...
  "sidebar.filterPlaceholder": "Filter projects and agents",
  "sidebar.filterAria": "Filter sidebar",
  ...
  "sidebar.rollup": "{total} agents, {attention} need attention",
  "sidebar.rollupClean": "{total} agents, all clear",
  "sidebar.jumpHint": "Jump with \u2318{index}",
  ...
  "palette.action.newProject.label": "Add project",
  "palette.action.newProject.hint": "Create",
  ...
  "palette.action.attention.label": "Next item needing attention",
  "palette.action.attention.hint": "Go",
  "palette.action.shortcuts.label": "Keyboard shortcuts",
  "palette.action.shortcuts.hint": "Help",
  "palette.group.actions": "Commands",
  "palette.group.agents": "Workspaces",
  "palette.recent": "Recent",
  "palette.footer.navigate": "Move",
  "palette.footer.open": "Open",
  "palette.footer.close": "Close",

  // 단축키 도움말
  "shortcuts.title": "Keyboard shortcuts",
  "shortcuts.description": "Press \u2318/ anytime to reopen this list.",
  ...
  "shortcuts.jump": "Jump to workspace 1-9",
  "shortcuts.cycle": "Previous / next workspace",
  "shortcuts.attention": "Next item needing attention",
  "shortcuts.toggleLeft": "Toggle sidebar",
  "shortcuts.toggleRight": "Toggle file panel",
  "shortcuts.newAgent": "New agent",
  "shortcuts.fanout": "Fan-out",
  "shortcuts.tasks": "Task board",
  ...
  "filePanel.loadError": "Could not load files. Please try again.",

  // 프리뷰
  "preview.urlAria": "Preview URL",
  "preview.detectPorts": "Detect dev server ports",
  "preview.noPorts": "No ports detected.",
  "preview.portDetectionError": "Could not detect dev server ports.",
...
export const ko: Record<MessageKey, string> = {
  ...
  "contextMenu.selectAll": "전체 선택",
  "contextMenu.terminal": "터미널",
  "contextMenu.preview": "미리보기",
  "contextMenu.project": "프로젝트",
  "contextMenu.workspace": "워크스페이스",
  "contextMenu.folder": "폴더",
  "contextMenu.file": "파일",
  "contextMenu.addWorkspace": "워크스페이스 추가",
  "contextMenu.openFileManager": "파일 관리자에서 열기",
  "contextMenu.openNearestParent": "가장 가까운 상위 폴더에서 열기 ({path})",
  "contextMenu.renameWorkspace": "워크스페이스 이름 변경",
  "contextMenu.openInExternalApp": "외부 앱에서 열기",
  "contextMenu.deleteWorkspace": "워크스페이스 삭제",
  "contextMenu.expand": "펼치기",
  "contextMenu.collapse": "접기",
  "contextMenu.revealInFileManager": "파일 관리자에서 보기",
  "contextMenu.copyPath": "경로 복사",
  "contextMenu.openVSCode": "VS Code에서 열기",
  "contextMenu.openCursor": "Cursor에서 열기",
  "contextMenu.openZed": "Zed에서 열기",
  "renameAgent.title": "워크스페이스 이름 변경",
  "renameAgent.name": "워크스페이스 이름",
  "renameAgent.namePlaceholder": "워크스페이스 이름을 입력하세요",
  "renameAgent.saving": "저장 중…",
  ...
  "overview.firstRunTitle": "첫 프로젝트를 추가하세요",
  "overview.firstRunDesc": "Git 저장소를 연결하면 기본 작업환경이 함께 만들어져 바로 에이전트를 실행할 수 있습니다.",
  ...
  "sidebar.filterPlaceholder": "프로젝트·에이전트 거르기",
  "sidebar.filterAria": "사이드바 거르기",
  "sidebar.clearFilter": "필터 지우기",
  "sidebar.noMatches": "\u201c{query}\u201d와 일치하는 항목이 없습니다.",
  "sidebar.collapseProject": "{project} 접기",
  "sidebar.expandProject": "{project} 펼치기",
  "sidebar.rollup": "에이전트 {total}개, 주의 필요 {attention}건",
  "sidebar.rollupClean": "에이전트 {total}개, 모두 정상",
  "sidebar.jumpHint": "\u2318{index}로 이동",
  ...
  "palette.action.newProject.label": "프로젝트 추가",
  "palette.action.newProject.hint": "생성",
  ...
  "palette.action.attention.label": "다음 주의 필요 항목",
  "palette.action.attention.hint": "이동",
  "palette.action.shortcuts.label": "키보드 단축키",
  "palette.action.shortcuts.hint": "도움말",
  "palette.group.actions": "명령",
  "palette.group.agents": "워크스페이스",
  "palette.recent": "최근",
  "palette.footer.navigate": "이동",
  "palette.footer.open": "열기",
  "palette.footer.close": "닫기",

  // 단축키 도움말
  "shortcuts.title": "키보드 단축키",
  "shortcuts.description": "언제든 \u2318/ 로 이 목록을 다시 열 수 있습니다.",
  "shortcuts.group.navigation": "이동",
  "shortcuts.group.workspace": "워크스페이스",
  "shortcuts.group.view": "화면",
  "shortcuts.group.create": "생성",
  "shortcuts.palette": "명령 팔레트",
  "shortcuts.overview": "전체 오버뷰",
  "shortcuts.jump": "1~9번 워크스페이스로 점프",
  "shortcuts.cycle": "이전 / 다음 워크스페이스",
  "shortcuts.attention": "다음 주의 필요 항목",
  "shortcuts.toggleLeft": "사이드바 토글",
  "shortcuts.toggleRight": "파일 패널 토글",
  "shortcuts.newAgent": "새 에이전트",
  "shortcuts.fanout": "팬아웃",
  "shortcuts.tasks": "태스크 보드",
  ...
  "filePanel.loadError": "파일을 불러오지 못했습니다. 다시 시도해 주세요.",

  // 프리뷰
  "preview.urlAria": "프리뷰 URL",
  "preview.detectPorts": "dev 서버 포트 감지",
  "preview.noPorts": "감지된 포트가 없습니다.",
  "preview.portDetectionError": "dev 서버 포트를 감지하지 못했습니다.",
